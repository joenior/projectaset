...
@section('content')
    ...
    <h1 class="h3 mb-4">Tambah Lantai Baru</h1>
                ...
                <div class="card-body">
                    <form action="/lantai" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('nama_lantai') is-invalid @enderror" id="nama_lantai" name="nama_lantai" value="{{ old('nama_lantai') }}">
                            @error('nama_lantai')
